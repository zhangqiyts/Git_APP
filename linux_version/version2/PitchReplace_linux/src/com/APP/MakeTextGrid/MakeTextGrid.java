...
//    			System.out.println("****"+syllable);
	...
	public static void MakeAlignTextGrid(String pitchReplacePath) throws IOException {
		try {	
			String[] cmd = { "perl", "/home/APP/workspace_perl/MakeTextGrid/mkAlignTextGrid.pl", pitchReplacePath};
	...
	public static void MakeOutTextGrid(String pitchReplacePath) throws IOException{
		try {
			String[] cmd = { "perl", "/home/APP/workspace_perl/MakeTextGrid/multiCreateTextGrid.pl", pitchReplacePath};
			Process pr = Runtime.getRuntime().exec(cmd);	
			pr.waitFor();
		} catch (InterruptedException e) {
			e.printStackTrace();
